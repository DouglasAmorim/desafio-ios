//
//  CharacterFilterViewModelTest.swift
//  desafio-iosTests
//
...
final class CharacterFilterViewModelTest: XCTestCase {
    private var mockCharacterService: MockCharacterService?
    private var viewModel: CharacterFilterViewModel?
    ...
    override func setUpWithError() throws {
        ...
        if let mock = self.mockCharacterService {
            self.viewModel = CharacterFilterViewModel(characterService: mock)
        }
    }
    ...
    func testGetCharacterFilterList() throws {
